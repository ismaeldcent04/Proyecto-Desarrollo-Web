...
function ProfileDescription({ displayName, username,avatar,datejoined,amount,following,followers }) {
    return (
        <div className="profile_description">
            <div className="profileFeed_header">

                <a href="/"><ArrowBackIcon className="icon"/></a>
            ...
            <div className="portrait">
                <div><Avatar src={avatar} className="profile_image" /></div>
